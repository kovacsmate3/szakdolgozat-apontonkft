...
import { getOtherLaws } from "@/server/laws";
...
export default function OtherLawsPageClient({ token }: Props) {
  const {
    data: laws,
    isLoading,
    error,
    ...
    return (
      <div className="container mx-auto py-10">
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-2xl font-semibold">További jogszabályok</h1>
        </div>
