...
import { getPropertyRegistryLaws } from "@/server/laws";
...
export default function PropertyRegistryLawsPageClient({ token }: Props) {
  const {
    data: laws,
    isLoading,
    error,
    ...
    queryFn: () => getPropertyRegistryLaws(token),
  });
